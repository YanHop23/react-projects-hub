    ...
    return (
        <>
            <div className="search">
                ...
                <input value={searchValue} onChange={onChangeSearchValue} type="text" placeholder="Найти користувача..." />
            </div>
            {isLoading ? (
                ...
                <ul className="users-list">
                    {items.filter((obj) => {
                        ...
                        <User isInvited={invites.includes(obj.id)} onClickInvite={onClickInvite} key={obj.id} {...obj}/>
                    ))
